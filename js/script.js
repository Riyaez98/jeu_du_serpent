...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    class Jeu{//On cree(initialise) la class jeu on va avoir le pointage, savoir quand le jeu est fini etc
    ...
    class Serpent{
        ...
        verifTouche(_evt){
            ...
            this.deplacementSerpent(evt.keyCode)
        }


        deplacementSerpent(dirCode){
        ...
        controleSerpent(){
            ...
            if(!this.touche){
                ...
                if(this.currentX=== this.leJeu.pomme.laPomme[1] && this.currentY === this.leJeu.pomme.laPomme[2]){
    ...
    class Pomme{
        ...
        ajoutePomme(){
            ...
            this.laPomme = [this.leJeu.s.rect(posX*this.leJeu.grandeurCarre,posY * this.leJeu.grandeurCarre,this.leJeu.grandeurCarre,this.leJeu.grandeurCarre).attr({fill:'red'}),posX, posY];
            //Ca va dessiner un carre a la position posx et posy de couleur red

        }

        supprimePomme(){
            this.laPomme[0].remove();
        }
    }
